                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <div style="font-size: 0.5rem;">
                                <a href="deleteReceipt.php?id=<?= $row["id"] ?>" onclick="return confirm('Do you want to delete?');"><img src="img/delete.png" alt="" width="26" height="26"></a>
                                <a href="pay.php?id=<?= $row["id"] ?>">&nbsp;&nbsp;&nbsp;<i class="fab fa-amazon-pay fa-3x"></i></a>
                            </div>
