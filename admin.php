...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end">
                ...
                <table style="width: 35%;">
                    <form class="form-inline my-2 my-lg-0">
                        <tr>
                            <td class="text-light">
                                <h6>Hi!, Welcome Administrator</h5>
                            </td>
                            <td>
    ...
    <!-- Awal Table -->
    <div class="container">
        <h4 align="center">Monitoring Borrowing Books</h4>
        <br>
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a href="edit.php?id=<?= $row["id"] ?>"><img src="img/edit.png" alt="" width="20" height="20"></a>
                        <a href="delete.php?id=<?= $row["id"] ?>" onclick="return confirm('Do you want to delete?');"><img src="img/delete.png" alt="" width="20" height="20"></a>
                    </td>
