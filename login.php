                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="col-12 mr-5 ">
                                    <input type="text" class="form-control shadow p-3" id="user" name="username" style="border-radius: 10px;" value="<?= $username; ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="password" class="col-sm-5 col-form-label text-light" style="text-align: center;">Password</label>
                            <div class="col-sm-12">
                                <div class="col-12 mr-5 ">
                                    <input type="password" class="form-control shadow p-3 mb-0" id="password" name="password" style="border-radius: 10px;" value="<?= $password; ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="col-12 px-1 mr-5 ">
                        ...
                        <div>
                            <center>
                                <div class="col-sm-10 mt-5">
                                    <button type="submit" class="btn btn-primary btn-block mt-5 justify-content-center shadow p-2 mb-0" data-toggle="modal" data-target="#exampleModal" style="border-radius: 20px;" name="login">
                                        Login
                                    </button>
                                </div>
                            </center>
