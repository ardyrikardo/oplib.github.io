...
<body>
                ...
                <table style="width: 35%;">
                    <form class="form-inline my-2 my-lg-0">
                        <tr>
                            ...
                            <td>
                                <a href="home.php"><button class="btn btn-outline-light" type="button">Logout</button></a>
                            </td>
    ...
    <!-- Awal Gutter -->
    <h4 align="center" id="reservasi">Update Borrowing Books</h4>
    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="col-12 mr-5">
                                <input type="text" class="form-control" id="nama" style="border-radius: 10px;" name="name" value="<?=$borrow_book["name"];?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="col-12 mr-5">
                                <input type="text" class="form-control" id="nim" style="border-radius: 10px;" name="sid" value="<?=$borrow_book["sid"];?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="col-12 mr-5">
                                <input type="text" class="form-control" id="code" style="border-radius: 10px;" name="codebook" value="<?=$borrow_book["codebook"];?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="col-12 mr-5">
                                <input type="text" class="form-control" id="title" style="border-radius: 10px;" name="title" value="<?=$borrow_book["title"];?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="col-12 mr-5">
                                <input type="number" class="form-control" id="duration" style="border-radius: 10px;" name="duration" placeholder="days" value="<?=$borrow_book["duration"];?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="col-12 mr-5">
                                <input type="text" class="form-control" id="duration" style="border-radius: 10px;" name="status"  value="<?=$borrow_book["status"];?>">
                            </div>  
                        </div>
                    </div>
                        ...
                        <div>
                            <center>
                                <div class="col-sm-10 mt-5">
                                    <button type="submit" class="btn btn-primary btn-block mt-5 justify-content-center shadow p-2 mb-0" data-toggle="modal" data-target="#exampleModal" style="border-radius: 20px;" name="borrow_update">
                                        Submit
                                    </button>
                                </div>
                            </center>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">Web Application Development</td>
                            </tr>
